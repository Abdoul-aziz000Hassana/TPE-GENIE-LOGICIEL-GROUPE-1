...
<img src="images/emprunt.png" width="120px">
<button type="submit" name="submit" class="btn add btn-success">
	<span class="glyphicon glyphicon-plus"></span> Ajouter une nouvel emprunt
</button>
